...
const TermsOfUseContent: React.FC = () => (
  <Box sx={{ color: "#f2f2f2" }}>
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>1. ACEITAÇÃO DOS TERMOS</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>2. FUNCIONALIDADES DO APLICATIVO</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>3. CLÁUSULA DE AUTORIZAÇÃO DE USO DE IMAGEM E BIOMETRIA</Typography>
    <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.8 }}>
      Ao utilizar o aplicativo e fornecer sua fotografia, o usuário autoriza expressamente:
      <br />a) A coleta, processamento e armazenamento de sua imagem facial;
      <br />b) A utilização de tecnologias de reconhecimento facial para mapeamento biométrico;
      <br />c) A comparação de sua biometria facial com imagens capturadas durante eventos, com a
      finalidade de identificar e disponibilizar fotos nas quais o usuário esteja presente;
      <br />d) O tratamento desses dados exclusivamente para as finalidades descritas neste termo,
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>4. CLÁUSULA DE ISENÇÃO DE RESPONSABILIDADE (GARANTIA PICBRAND)</Typography>
    <Typography variant="body1" sx={{ mb: 2, lineHeight: 1.8 }}>
      ...
      <br />a) Falhas, indisponibilidades ou instabilidades de conexão à internet do usuário;
      <br />b) Atrasos ou falhas no envio e recebimento de notificações push;
      <br />c) Falhas na entrega de e-mails, incluindo serviços de terceiros como sistemas de envio
      (ex.: Resend);
      <br />d) Interrupções temporárias do serviço decorrentes de manutenção, atualizações ou
      fatores externos;
      <br />e) Eventuais perdas de dados decorrentes de fatores alheios ao controle das empresas.
    </Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>5. CLÁUSULA DE PROPRIEDADE INTELECTUAL</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
      ...
      <br />b) A marca, identidade visual, conteúdos visuais e fotografias disponibilizadas na
      Plataforma pertencem à CLUBE N1, salvo quando indicado de outra forma;
      <br />c) É vedado ao usuário copiar, reproduzir, modificar, distribuir, realizar engenharia
      reversa ou explorar comercialmente qualquer parte da Plataforma sem autorização prévia e
      expressa dos titulares;
      <br />d) O uso indevido de qualquer propriedade intelectual poderá acarretar responsabilização
      civil e criminal.
    </Typography>

    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>6. PRIVACIDADE E PROTEÇÃO DE DADOS</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>7. CANCELAMENTO E EXCLUSÃO DE CONTA</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
      ...
      ({DATA_REMOVAL_URL}). Após a solicitação, os dados serão tratados conforme exigido por lei.
    </Typography>

    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>8. ALTERAÇÕES NOS TERMOS</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>9. LEGISLAÇÃO E FORO</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
    ...
    <Typography variant="h6" sx={{ fontWeight: 700, mt: 3, mb: 2 }}>10. CONTATO</Typography>
    <Typography variant="body1" sx={{ mb: 4, lineHeight: 1.8 }}>
