...
export default function DeleteSambaSchoolModal({
  open,
  schoolName,
  onClose,
  onConfirm,
  ...
  const handleConfirm = async () => {
    try {
      ...
      const message =
        error.response?.data?.detail || "Erro ao excluir escola de samba";
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ pt: 3, pb: 2 }}>
        ...
        >
          Tem certeza que deseja excluir esta escola de samba?
        </Typography>
        <Box
          sx={{
